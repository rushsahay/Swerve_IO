...
public final class Elastic {
    ...
    /**
     * Represents the possible levels of notifications for the Elastic dashboard. These levels are used to indicate the
     * severity or type of notification.
     */
     ...
     *
     * <p>If the given name is a number, Elastic will select the tab whose index equals the number provided.
     *
    ...
    public static class Notification {
         ...
         *
         * <p>The auto dismiss behavior can be re-enabled by setting the display time to a number greater than 0
         *
         * @return the current notification
         */
